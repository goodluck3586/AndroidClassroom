package com.example.lecture01_kkangsam91;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_visible.setOnClickListener(showImage);
        btn_invisible.setOnClickListener(showImage);

        // 5. MainActivity가 View.OnClickListener 구현
